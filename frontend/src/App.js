    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/addrenewals/:memno/:plan" element={<ProtectedRoute element={<AddRenewal />} requiredRole="Admin" />} />
          ...
          <Route path="/renew/:memno" element={<ProtectedRoute element={<Renewals />} requiredRole="Admin" />} />
