...
const emailSchema = new mongoose.Schema({
  memno: { type: Number, required: true, unique: true }, // memno as a required field
  email: { type: String, required: true, unique: true }, // email should be unique and required
...
const Email = mongoose.model('Email', emailSchema, 'renewals');
